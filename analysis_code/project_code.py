...
def main():
    ...
    # Sentiment of all summa summaries - uses sentiment_all to return dictionary with all sentiment scores for desires result (summary, keywords, etc)
    print("-"*50)
    pprint.pprint(sentiment_all(topics_summary_dictionary, 'Summa Summary'))
    # pprint.pprint(sentiment_all(topics_summary_dictionary, 'Summa Keywords'))

    # sample of text_similarity function using dictionary
    # This could dbe done for any topic or text
    sample1 = 'svb'
    sample2 = 'ftx'
    comparable_text = 'Summa Summary'
    print("-"*50)
    print(
        f"The text similarity between SVB and FTX summary is = {text_similarity(topics_summary_dictionary[sample1][comparable_text], topics_summary_dictionary[sample2][comparable_text])}")
    ...
    # EEverything after "THIS RESULTS IN" are generated by the code and were not summarized by Wikipedia
    print("-"*50)
    print(gpt_text_generation(trim_summary(
        topics_summary_dictionary['theranos']['Summa Summary'])))
    print("Everything after 'This resulted in' was generated by AI model")
